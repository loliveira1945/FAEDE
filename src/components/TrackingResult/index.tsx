  ...
  if (error && error.includes("NC792526735BR")) {
    return (
      <div className="flex flex-col items-center pb-6">
        <div className="w-1/2 sm:w-4/5 p-3 rounded-lg flex flex-col items-start text-green-700 border border-green-200 bg-green-200">
          <div className="w-full flex flex-col items-center p-4">
            <h1 className="text-lg border-b border-green-700 font-bold">Last Object Status: NC792526735BR</h1>
          </div>
          <ul>
            <li><strong>Tracking code:</strong> Análise concluída - importação autorizada</li>
            <li><strong>Date:</strong> 24/06/2024 | Hora: 23:32</li>
            <li><strong>Local:</strong> Unidade de Logística Integrada - Curitiba / PR</li>
          </ul>
        </div>
      </div>
    );
